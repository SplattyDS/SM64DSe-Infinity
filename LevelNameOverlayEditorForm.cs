...
namespace SM64DSe
{
    public partial class LevelNameOverlayEditorForm : Form
    {
        ...
        public LevelNameOverlayEditorForm(string fileName)
        {
            InitializeComponent();
        ...
        public LevelNameOverlayEditorForm()
            : this(null) { }

        private void LevelNameOverlayEditorForm_Load(object sender, System.EventArgs e)
        {
        ...
        private void lstLevels_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            nudOverlayID.Value = m_OverlayIDs[lstLevels.SelectedIndex];
        ...
        private void nudOverlayID_ValueChanged(object sender, EventArgs e)
        {
            if (m_UpdatingTextBoxes || lstLevels.SelectedIndex < 0)
                return;

            m_OverlayIDs[lstLevels.SelectedIndex] = (uint)nudOverlayID.Value;
        }
